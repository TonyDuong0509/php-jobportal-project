        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form action="<?php echo $router->generate('auth.company.login'); ?>" method="POST" class="md-float-material form-material">
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-center">Sign In Company</h3>
                                    </div>
                                </div>
                                ...
                                <p style="text-decoration: underline; margin-top: 15px;">You don't have account ? Please click <a style="color: blue" href="/company/register/form">here</a> to register !</p>
