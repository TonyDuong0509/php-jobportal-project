...
<!-- Mirrored from techydevs.com/demos/themes/html/zobstar-demo/zobstar/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Sep 2024 15:37:39 GMT -->
...
<head>
    ...
    <title>Zobstar - Job Portal</title>
    <!-- Favicon -->
    <link rel="icon" href="<?php ABSPATH ?> public/user/images/favicon.png" />

    <!-- Google Fonts -->
    <link
        href="../../../../../../fonts.googleapis.com/cssd0c0.css?family=Noto+Sans+JP:100,300,400,500,700,900&amp;display=swap"
        rel="stylesheet" />

    <!-- Template CSS Files -->
    <link rel="stylesheet" href="<?php ABSPATH ?> public/user/css/bootstrap.min.css" />
    <link rel="stylesheet" href="<?php ABSPATH ?> public/user/css/line-awesome.css" />
    <link rel="stylesheet" href="<?php ABSPATH ?> public/user/css/owl.carousel.min.css" />
    <link rel="stylesheet" href="<?php ABSPATH ?> public/user/css/owl.theme.default.min.css" />
    <link rel="stylesheet" href="<?php ABSPATH ?> public/user/css/magnific-popup.css" />
    <link rel="stylesheet" href="<?php ABSPATH ?> public/user/css/daterangepicker.css" />
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <ul class="dropdown-menu-item">
                                                ...
                                                <li>
                                                    <a href="employer-dashboard-edit-profile.html">Edit Profile</a>
                                                </li>
                                                <li>
                                        ...
                                        <li>
                                            ...
                                            <ul class="dropdown-menu-item">
                                                <li>
                                                    <a href="candidate-listing.html">Candidate Listing</a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a href="candidate-dashboard-edit-profile.html">Edit Profile</a>
                                                </li>
                                                <li>
                                                    <a href="candidate-add-resume.html">Add a Resume</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <ul class="dropdown-menu-item">
                                                ...
                                                <li>
                                                    <a href="job-grid-view.html">Job Grid View</a>
                                                </li>
                    ...
                    <div class="hero-content-wrapper position-relative">
                        <div class="hero-heading text-center">
                            ...
                            <div class="btn-box margin-top-35px">
                                <a href="job-grid-view.html" class="theme-btn me-2">Find a Job</a>
                                <a
                                    href="employer-dashboard-post-job.html"
        ...
        <div class="container">
            ...
            <div class="row mt-4">
                <div class="col-lg-6 mx-auto">
                    <ul
                        class="list-items job-tags d-flex flex-wrap justify-content-center">
...
================================= -->
    <section
        class="cat-area padding-top-100px padding-bottom-110px text-center">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading">
...
================================= -->
    <section
        class="hiw-area text-center section-bg padding-top-100px padding-bottom-85px">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading">
	...
	c122.181,0,224.354-85.6,249.86-200.095L394.59,200.631v-0.087h-0.087L339.155,145.196z" />
                                ...
                                "
                                                            ...
                                                            <g>
                                                                <path
                                                                    style="fill: #e8bc1e"
                                                                    d="M96.345,141.804h91.294c18.071,0,31.547,0.754,40.427,2.26c8.881,1.506,16.826,4.649,23.837,9.425
                                                                ...
                                                                <path
                                                                    style="fill: #e8bc1e"
                                                                    d="M352.249,370.196h-43.778V204.745h40.663v23.524c6.957-11.112,13.215-18.435,18.772-21.966
                                ...
                                "
                                                            ...
                                                            <path
                                                                style="fill: #ffffff"
                                                                d="M400.687,310.23c0,0-0.337-15.513-24.617-23.774s-77.899,0-77.899,0
...
================================= -->
    <section
        class="funfact-area section-bg-2 padding-top-100px padding-bottom-60px text-center">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading">
                    ...
                    <div class="counter-item">
                        ...
                        <div class="counter-number">
                            <span
                                ...
                                data-purecounter-end="19000"
                                class="counter purecounter">0</span>
                        </div>
                        <!-- end counter-number -->
...
================================= -->
    <section
        class="testimonial-area padding-top-100px padding-bottom-100px text-center">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading">
                    ...
                    <div class="testimonial-carousel carousel-item-wrap">
                        <div class="testimonial-item">
                            <div class="testi-content mb-3">
                                <img
                                    src="<?php ABSPATH ?> public/user/images/small-team1.jpg"
                                    class="testi__img"
                        ...
                        <div class="testimonial-item">
                            <div class="testi-content mb-3">
                                <img
                                    src="<?php ABSPATH ?> public/user/images/small-team2.jpg"
                                    class="testi__img"
                                    alt="testimonial image" />
                        ...
                        <div class="testimonial-item">
                            <div class="testi-content mb-3">
                                <img
                                    src="<?php ABSPATH ?> public/user/images/small-team3.jpg"
                                    class="testi__img"
                                    alt="testimonial image" />
...
================================= -->
    <section
        class="clientlogo-area padding-top-95px padding-bottom-90px text-center">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading">
            ...
            <div class="row margin-top-35px">
                <div class="col-lg-9 mx-auto">
                    <div
                        class="client-logo-wrap d-flex flex-wrap justify-content-center align-items-center">
                        <div class="client-logo-item">
                            <img
                                src="<?php ABSPATH ?> public/user/images/client-logo.png"
                                class="img-fluid"
                                alt="brand-image" />
                        </div>
                        ...
                        <div class="client-logo-item">
                            <img
                                src="<?php ABSPATH ?> public/user/images/client-logo-2.png"
                                class="img-fluid"
                                alt="brand-image" />
                        </div>
                        <!-- end client-logo-item -->
                        <div class="client-logo-item">
                            <img
                                src="<?php ABSPATH ?> public/user/images/client-logo-3.png"
                                class="img-fluid"
                                alt="brand-image" />
                        </div>
                        <!-- end client-logo-item -->
                        <div class="client-logo-item">
                            <img
                                src="<?php ABSPATH ?> public/user/images/client-logo-4.png"
                                class="img-fluid"
                                alt="brand-image" />
                        </div>
                        <!-- end client-logo-item -->
                        <div class="client-logo-item">
                            <img
                                src="<?php ABSPATH ?> public/user/images/client-logo-5.png"
                                class="img-fluid"
                                alt="brand-image" />
                        </div>
                        <!-- end client-logo-item -->
                        <div class="client-logo-item">
                            <img
                                src="<?php ABSPATH ?> public/user/images/client-logo-6.png"
                                class="img-fluid"
                                alt="brand-image" />
                        </div>
                        <!-- end client-logo-item -->
                        <div class="client-logo-item">
                            <img
                                src="<?php ABSPATH ?> public/user/images/client-logo-7.png"
                                class="img-fluid"
                                alt="brand-image" />
                        </div>
                        <!-- end client-logo-item -->
                        <div class="client-logo-item">
                            <img
                                src="<?php ABSPATH ?> public/user/images/client-logo-8.png"
                                class="img-fluid"
                                alt="brand-image" />
                        </div>
                        <!-- end client-logo-item -->
                        <div class="client-logo-item">
                            <img
                                src="<?php ABSPATH ?> public/user/images/client-logo-9.png"
                                class="img-fluid"
                                alt="brand-image" />
                        </div>
                        <!-- end client-logo-item -->
                        <div class="client-logo-item">
                            <img
                                src="<?php ABSPATH ?> public/user/images/client-logo-10.png"
                                class="img-fluid"
                                alt="brand-image" />
                        </div>
                        <!-- end client-logo-item -->
                        <div class="client-logo-item">
                            <img
                                src="<?php ABSPATH ?> public/user/images/client-logo-11.png"
                                class="img-fluid"
                                alt="brand-image" />
                        </div>
                        <!-- end client-logo-item -->
...
================================= -->
    <section
        class="cta-area section-bg responsive-text-center padding-top-80px padding-bottom-80px">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="mobile-img">
                        <img src="<?php ABSPATH ?> public/user/images/mobile.png" alt="mobile-img" />
                    </div>
                </div>
                <!-- end col-lg-5 -->
                ...
                <div class="col-lg-4 responsive-column">
                    <div class="card-item">
                        <div class="card-content-wrap">
                            ...
                            <img src="<?php ABSPATH ?> public/user/images/img1.jpg" alt="blog image" class="img-fluid" />
                            <div class="card-content">
                                ...
                                <p class="card-meta">
                                    <img
                                        ...
                                        alt=""
                                        class="author-avatar" />
                                    <span class="font-weight-semi-bold">Kamran Adi</span> - 25
                                    Jan, 2020
                                </p>
                            </div>
                            <!-- end card-content -->
                ...
                <div class="col-lg-4 responsive-column">
                    <div class="card-item">
                        <div class="card-content-wrap">
                            ...
                            <img src="<?php ABSPATH ?> public/user/images/img2.jpg" alt="blog image" class="img-fluid" />
                            <div class="card-content">
                                <h4 class="card-title">
                                ...
                                <p class="card-meta">
                                    <img
                                        ...
                                        alt=""
                                        class="author-avatar" />
                                    <span class="font-weight-semi-bold">David Wise</span> - 25
                                    Jan, 2020
                                </p>
                            </div>
                            <!-- end card-content -->
                ...
                <div class="col-lg-4 responsive-column">
                    <div class="card-item">
                        <div class="card-content-wrap">
                            ...
                            <img src="<?php ABSPATH ?> public/user/images/img3.jpg" alt="blog image" class="img-fluid" />
                            <div class="card-content">
                                <h4 class="card-title">
                                ...
                                <p class="card-meta">
                                    <img
                                        ...
                                        alt=""
                                        class="author-avatar" />
                                    <span class="font-weight-semi-bold">Mike Doe</span> - 25
                                    Jan, 2020
                                </p>
                            </div>
                            <!-- end card-content -->
...
================================= -->
    <section
        class="cta-area cta-area-2 responsive-text-center section-bg-2 padding-top-70px padding-bottom-70px">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-9">
                    <div class="section-heading">
                        <h2
                            class="sec__title mb-2 text-white font-size-26 line-height-40">
            ...
            <div class="row">
                <div class="col-lg-4 responsive-column">
                    <div class="footer-item">
                        <div class="logo">
                            <a href="index.html" class="foot-logo"><img src="<?php ABSPATH ?> public/user/images/logo2.png" alt="logo" /></a>
...
================================= -->
    ...
    <!-- Template JS Files -->
    <script src="<?php ABSPATH ?> public/user/js/jquery-3.7.1.min.js"></script>
    <script src="<?php ABSPATH ?> public/user/js/jquery-ui.js"></script>
    <script src="<?php ABSPATH ?> public/user/js/bootstrap.bundle.min.js"></script>
    <script src="<?php ABSPATH ?> public/user/js/owl.carousel.min.js"></script>
    <script src="<?php ABSPATH ?> public/user/js/jquery.magnific-popup.min.js"></script>
    <script src="<?php ABSPATH ?> public/user/js/isotope-3.0.6.min.js"></script>
    <script src="<?php ABSPATH ?> public/user/js/chosen.min.js"></script>
    <script src="<?php ABSPATH ?> public/user/js/moment.min.js"></script>
    <script src="<?php ABSPATH ?> public/user/js/daterangepicker.js"></script>
    <script src="<?php ABSPATH ?> public/user/js/purecounter.js"></script>
    <script src="<?php ABSPATH ?> public/user/js/progresscircle.js"></script>
    <script src="<?php ABSPATH ?> public/user/js/main.js"></script>
</body>
